...
class GameWindow < Gosu::Window
  ...
  def update
    ...
    if button_down?(Gosu::KbLeft) && (@shape_x !=0) && (@shape_x > 0)
        @shape_x -= 3
     end

    if button_down?(Gosu::KbUp) && (@shape_y !=0) && (@shape_y > 0)
         @shape_y -= 3
    end
  ...
  # This is procedure i.e the return value is 'undefined'
  def draw
    Gosu.draw_rect(@shape_x, @shape_y, SHAPE_DIM, SHAPE_DIM, Gosu::Color::YELLOW, ZOrder::TOP, mode=:default)
  end
end
